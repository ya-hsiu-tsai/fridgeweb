...
function select_area(index)
{
    for(var i=0; i<areaArr[index].length; i++)
        document.select_location.area.options[i] = new Option(areaArr[index][i], areaArr[index][i]);
    document.select_location.area.length = areaArr[index].length;
}